...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST { 20.86, 20.86 }
    #define DEFAULT_Ki_LIST {  1.73,  1.73 }
    #define DEFAULT_Kd_LIST { 62.81, 62.81 }
  #else
    #define DEFAULT_Kp  20.86
    #define DEFAULT_Ki   1.73
    #define DEFAULT_Kd  62.81
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 89.69
  #define DEFAULT_bedKi 17.92
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 320, 6400, 599.92 }
